...
SQL проект реализованный на postgresql. В нем содержаться скрипты, необходимые для создания базы данных о клиентах розничных сетей, а также для создания персональных предложений для клиентов.
